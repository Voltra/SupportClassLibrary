...
- Replace all occurrences of "SupportClassLibrary" in the relevant CMakeLists.txt with the name of your project
  - Capitalization matters here: `SupportClassLibrary` means the name of the project, while `SupportClassLibrary` is used in file names.
  - Remember to rename the `include/SupportClassLibrary` directory to use your project's lowercase name and update all relevant `#include`s accordingly.
...
./build/standalone/SupportClassLibrary --help
```
...
CTEST_OUTPUT_ON_FAILURE=1 cmake --build build/tests --target tests

# or simply call the executable: 
./build/tests/SupportClassLibraryTests
```
