        ...
        namespace details {
            ...
            class StreamPayload {
                ...
                public:
                     ...
                     * @return an Either containing a value on its left or an invalid tag on its
                     * right
                     */
                    alternative& value() {
                        ensureGenerated();
