...
namespace scl {
    namespace meta {
         ...
         */
        template <class T> inline constexpr bool is_copyable() {
        ...
        template <class T> inline constexpr bool is_trivially_copyable() {
            return is_trivially_copy_assignable<T>() && is_trivially_copy_constructible<T>();
        }
         ...
         */
        template <class T> inline constexpr bool is_nothrow_copyable() {
