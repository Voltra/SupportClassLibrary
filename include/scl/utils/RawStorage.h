...
#include "./exchange.h"
    ...
    #warning \
	"scl::utils::RawStorage's get() is unsafe without exceptions. Make sure you check your object's lifetime (i.e. no use-after-move) and use hasValue()"
#endif
...
namespace scl {
	...
	namespace details {
		...
		protected:
		     ...
		     */
		    alignas(value_type) storage_type storage;
