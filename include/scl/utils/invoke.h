...
#include "../meta/type_queries/exists.h"
...
namespace scl {
	...
	inline constexpr auto invoke(F&& fn, Args&&... args)
		...
		template <class Ret, class Class, class... Args>
		inline Ret
	    invoke(scl::alias::mem_fn_type<Ret, Class, Args...> fn, Class* obj, Args&&... args) {
	...
	template <class Ret, class Class>
	inline const Ret& invoke(scl::alias::const_mem_var_type<Ret, Class> fn, const Class* obj) {
	    return obj->*fn;
	}
    }  // namespace utils
}  // namespace scl