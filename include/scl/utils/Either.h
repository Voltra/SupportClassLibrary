    ...
    namespace utils {
        ...
        class Either : private details::EitherPayload<LeftType, RightType> {
            public:
                ...
                static constexpr bool left_nothrow_movable
                    = scl::meta::is_nothrow_movable<left_type>();
                static constexpr bool right_nothrow_movable
                    = scl::meta::is_nothrow_movable<left_type>();
                static constexpr bool nothrow_movable
                    = left_nothrow_movable && right_nothrow_movable;
